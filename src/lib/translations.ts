...
export const translations: Translations = {
  no: {
    ...
    'log.nsf_training_weapon': '6 måneder (NSF)',
    'log.nsf_requirement': 'Krav: 10 treninger siste 6 måneder (NSF)',
    ...
    'log.nsf_training_weapons': '6 måneder (NSF)',
    'log.nsf_requirement_text': 'Krav: 10 treninger siste 6 måneder (NSF)',
    ...
    'log.nsf_info_10_trainings': '• Minst 10 treninger siste 6 måneder',
    ...
    'log.dfs_info_10_trainings': '(Det stilles ikke krav om å fullføre x antall treningsøkter, så vi viser bare antall registrerte treninger uten mål)',
    'log.dfs_info_field_hunting': '• Være medlem i godkjent DSF-klubb',
    ...
    'log.dssn_info_weapons': '(For å telle om du har nok treninger må de ha skutt aktivt i løpet av de siste 12 månedene)',
    'log.dssn_info_same_rules': '• Medlemskap i Sportsskyttere med tilslutning til DSSN.',
    'log.dssn_info_rifle_exception': '• Gjennomført sikkerhetskurs.',
    'log.dssn_info_activity_requirement': '• Skutt aktivt i minimum 1 år.',
    'log.dssn_info_green_activities': '• Inneha våpen godkjent for en av divisjonene i dynamisk skyting.',
    'log.dssn_info_equipment': '• Inneha nødvendig tilleggsutstyr, som hylster, magasiner, magasinholdere etc.',
    'log.dssn_info_course': '• Gjennomført og bestått godkjenningskurs i «Dynamisk Skyting».',
  ...
  en: {
    ...
    'log.nsf_info_10_trainings': '• At least 10 trainings in the last 6 months',
    ...
    'log.dssn_info_same_rules': '• Membership in Sport Shooters affiliated with DSSN.',
    'log.dssn_info_rifle_exception': '• Completed safety course.',
    'log.dssn_info_activity_requirement': '• Shot actively for minimum 1 year.',
    'log.dssn_info_green_activities': '• Possess weapon approved for one of the divisions in dynamic shooting.',
    'log.dssn_info_equipment': '• Possess necessary additional equipment, such as holsters, magazines, magazine holders etc.',
    'log.dssn_info_course': '• Completed and passed approval course in «Dynamic Shooting».',
